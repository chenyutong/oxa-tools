...
function Get-LatestChanges
{
   ...
   { 
       ...
       # git clone git@github.com:iovex/oxa-tools.git -b $BranchName $enlistmentRootPath -q
	   git clone git@github.com:chenyutong/oxa-tools.git -b $BranchName $enlistmentRootPath -q
   }
